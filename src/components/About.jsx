        ...
        <div class = "about-container">
            ...
            <div class = "about">
                <div class = "about-bg">
                    ...
                    <button id = "futureplansbutton" onClick={(event) => handlePopup(event, "Future Plans",
                    ...
                    <div class = "about-popup-container"
                        ...
                        <div class = "about-popup-bg">
                            ...
                            popupHeaderText == "Future Plans" ? <Spritesheet_About_Popup_FuturePlans /> : <div/>
                            }
                        </div>
                        <div class="about-popup">
                            <h class = {popup === true ? "about-info-header" : ""}
                                style={{color: popupHeaderText == "Laser Cats Collection" ? '#02f0d8' : 
                                        ...
                                        popupHeaderText == "Future Plans" ? '#ff01cb' : "#ffffff"
                                    }}
                            ><u>{popupHeaderText}</u></h>
                            <p class = {popup === true ? "about-info" : ""}
                            >{popupText}</p>
                        </div>
                    </div>
                </div>
